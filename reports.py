...
sausalitopd_csv = "departments/sausalitopd.csv"
...
parkpolice_csv = "departments/parkpolice.csv"
other_csv = "departments/other.csv"
pds = [sheriff_csv, rafaelpd_csv, fairfaxpd_csv, novatopd_csv, centralmarinpd_csv, sausalitopd_csv, chp_csv, doc_csv, millvalleypd_csv, probation_csv, compd_csv, tiburonpd_csv, rosspd_csv, belvederepd_csv, court_csv, parkpolice_csv, other_csv]
pd_name = ['Marin County Sheriff Department', 'San Rafael PD', 'Fairfax PD', 'Novato PD', 'Central Marin Police Authority', 'Sausalito PD', 'California Highway Patrol', 'Department of Corrections', 'Mill Valley PD', 'Probation', 'College of Marin PD', 'Tiburon PD', 'Ross PD', 'Belvedere PD', 'Court', 'US Park Police', 'Other']
